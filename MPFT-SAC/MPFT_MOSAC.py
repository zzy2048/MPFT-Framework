...
class mpft_mosac:
    def __init__(self, environment, eval_env, num_objectives, lr=3e-4, seed=42, steps=2000, use_seed=False):
        ...
        self.opposite_num = 1  # Halfcheetach || Swimmer: 0 else 1
        self.edge_direction = [0, 1, 2]
        self.Warmup_steps = [600, 600, 600]
        self.Xi = [800, 800, 800, 800]
        self.Psi = [600, 600, 600, 600]
        self.J_max = [np.array([3100, 3000, 3000]), np.array([3000, 3100, 3000]), np.array([3000, 3000, 3000]),
    ...
    def initialize_environment(self, ):
        self.edge1 = SAC_edge.SAC_EDGE(self.env, self.eval_env, self.num_objectives, lr=self.lr, seed=self.seed,
        ...
        self.edge2 = SAC_edge.SAC_EDGE(self.env, self.eval_env, self.num_objectives, lr=self.lr, seed=self.seed,
        ...
        self.inner = SAC_inner.SAC_INNER(self.env, self.eval_env, self.num_objectives, lr=self.lr, seed=self.seed,
        ...
        if self.num_objectives == 3:
            self.edge3 = SAC_edge.SAC_EDGE(self.env, self.eval_env, self.num_objectives, lr=self.lr, seed=self.seed,
    ...
    def train(self):
        ...
        if not self.use_priority_knowledge:
            edge_tasks = [
                (self._train_edge, (SAC_edge.SAC_EDGE, self.env, self.eval_env, self.num_objectives,
            ...
            for i in range(self.topK):
                inner_tasks.append(
                    (self._train_inner, (SAC_inner.SAC_INNER, self.env, self.eval_env, self.num_objectives,
...
if __name__ == "__main__":
    ...
    morl = mpft_mosac(env, eval_env, obj_num, lr=3e-4, seed=seed, steps=steps, use_seed=use_seed)
...
# self.Xi = [300, 300, 300]
# self.Psi = [200, 200, 200]
# self.J_max = [np.array([1800, 1600]), np.array([1600, 1800]), np.array([1650, 1650])]


# HalfCheetah  steps = 2000
# self.Warmup_steps = [380, 380]
# self.Xi = [500, 500, 500]
# self.Psi = [400, 400, 400]
# self.J_max = [np.array([1700, 1500]), np.array([1500, 1700]), np.array([1600, 1600])]


# Walk2D  steps = 2000
# self.Warmup_steps = [200, 0]
# self.Xi = [1000, 400, 500]
# self.Psi = [500, 1000, 600]
# self.J_max = [np.array([5000., 3000.]), np.array([3000., 4000.]), np.array([3000., 3500.])]
...
# self.Xi = [700, 700, 700]
# self.Psi = [400, 400, 400]
# self.J_max = [np.array([4000., 3000.]), np.array([3000., 4500.]), np.array([3000., 4000.])]
...
# self.Xi = [3000, 2000, 1500]
# self.Psi = [1200, 2000, 1700]
# self.J_max = [np.array([5000, 5000]), np.array([4300., 6000.]), np.array([5300., 6200.])]
